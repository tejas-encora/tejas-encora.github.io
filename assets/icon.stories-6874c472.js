/* empty css              */import{r as d,c as p,w as m,o as u,b as v,n as y}from"./vue.esm-bundler-82ad5dd9.js";import{_}from"./_plugin-vue_export-helper-c27b6911.js";import{c as f,_ as h,e as g}from"./delegate-d56dde3e.js";import{s as b,I as x}from"./shared-styles.css-4d0e8689.js";import"./form-submitter-62a5024b.js";const c={name:"IOButtonIcon",props:{icon:{type:String,default:"file-magnifying-glass"}},computed:{iconClass(){return`fa-light fa-${this.icon}`}}};function I(e,w,k,C,O,i){const l=d("md-icon-button");return u(),p(l,null,{default:m(()=>[v("i",{class:y(i.iconClass)},null,2)]),_:1})}const t=_(c,[["render",I]]);c.__docgenInfo={displayName:"IOButtonIcon",exportName:"default",description:"",tags:{},props:[{name:"icon",type:{name:"string"},defaultValue:{func:!1,value:"'file-magnifying-glass'"}}],sourceFiles:["/Users/tmonteverdi/Sites/localhost/material-test/src/components/Buttons/IOButtonIcon.vue"]};/**
  * @license
...
//# sourceMappingURL=icon.stories-6874c472.js.map
