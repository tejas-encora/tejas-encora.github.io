import{c as E,i as H,C as T}from"./menu-Cce92um_.js";import{e as R,_ as n,n as m,s as _,x as u,i as S,f as N,c as A,T as d,d as K}from"./animation-_TEqrmD1.js";import"./ripple-7WbymdBP.js";import{o as D}from"./query-assigned-elements-BJFWMYs6.js";import{s as f,n as Z}from"./static-VcHqXR5s.js";import{r as F}from"./delegate-G9HsjGKO.js";import{H as I,K as P,d as k,f as v,m as a,g as $,y as p,w as c,o as x}from"./vue.esm-bundler-IQnt_YWr.js";/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let W;function j(s){return(o,t)=>R(o,t,{get(){return(this.renderRoot??W??(W=document.createDocumentFragment())).querySelectorAll(s)}})}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function q(s){return(o,t)=>{const{slot:e}=s??{},r="slot"+(e?`[name=${e}]`:":not([name])");return R(o,t,{get(){var y;const l=(y=this.renderRoot)==null?void 0:y.querySelector(r);return(l==null?void 0:l.assignedNodes(s))??[]}})}}/**
 * @license
 ...
 */class i extends _{constructor(){super(...arguments),this.disabled=!1,this.type="menuitem",this.href="",this.target="",this.keepOpen=!1,this.selected=!1,this.menuItemController=new G(this,{getHeadlineElements:()=>this.headlineElements,getSupportingTextElements:()=>this.supportingTextElements,getDefaultElements:()=>this.defaultElements,getInteractiveElement:()=>this.listItemRoot})}get typeaheadText(){return this.menuItemController.typeaheadText}set typeaheadText(o){this.menuItemController.setTypeaheadText(o)}render(){return this.renderListItem(u`
    ...
    `)}renderListItem(o){const t=this.type==="link";let e;switch(this.menuItemController.tagName){case"a":e=f`a`;break;case"button":e=f`button`;break;default:case"li":e=f`li`;break}const r=t&&this.target?this.target:d;return Z`
      <${e}
        id="item"
    ...
    `}focus(){var o;(o=this.listItemRoot)==null||o.focus()}}F(i);i.shadowRootOptions={..._.shadowRootOptions,delegatesFocus:!0};n([m({type:Boolean,reflect:!0})],i.prototype,"disabled",void 0);n([m()],i.prototype,"type",void 0);n([m()],i.prototype,"href",void 0);n([m()],i.prototype,"target",void 0);n([m({type:Boolean,attribute:"keep-open"})],i.prototype,"keepOpen",void 0);n([m({type:Boolean})],i.prototype,"selected",void 0);n([A(".list-item")],i.prototype,"listItemRoot",void 0);n([D({slot:"headline"})],i.prototype,"headlineElements",void 0);n([D({slot:"supporting-text"})],i.prototype,"supportingTextElements",void 0);n([q({slot:""})],i.prototype,"defaultElements",void 0);n([m({attribute:"typeahead-text"})],i.prototype,"typeaheadText",null);/**
  * @license
  * Copyright 2022 Google LLC
  * SPDX-License-Identifier: Apache-2.0
...
})`,...(z=(M=g.parameters)==null?void 0:M.docs)==null?void 0:z.source}}};const ce=["Default"],_e=Object.freeze(Object.defineProperty({__proto__:null,Default:g,__namedExportsOrder:ce,default:de},Symbol.toStringTag,{value:"Module"}));export{_e as O};
