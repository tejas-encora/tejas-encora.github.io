 ...
 */class r extends i{constructor(){super(...arguments),this.disabled=!1,this.alwaysFocusable=!1,this.label=""}get rippleDisabled(){return this.disabled}focus(a){this.disabled&&!this.alwaysFocusable||super.focus(a)}render(){return e`
    ...
    `}}s(r);r.shadowRootOptions={...i.shadowRootOptions,delegatesFocus:!0};o([t({type:Boolean})],r.prototype,"disabled",void 0);o([t({type:Boolean,attribute:"always-focusable"})],r.prototype,"alwaysFocusable",void 0);o([t()],r.prototype,"label",void 0);export{r as C,h as s};
//# sourceMappingURL=chip-5cd5e483.js.map
