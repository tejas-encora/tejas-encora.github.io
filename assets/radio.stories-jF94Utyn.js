import{_ as d,n as _,c as q,s as L,x as z,d as D,i as U,f as M}from"./animation-_TEqrmD1.js";import"./ripple-7WbymdBP.js";import{i as O}from"./events-SXK1JT6v.js";import{V,m as K,a as N,g as P,b as j,c as H,d as J}from"./validator-bsz2Xc5j.js";import{m as Q,i as R}from"./element-internals-MRZXgA-l.js";import{l as W,b as X,o as Y}from"./vue.esm-bundler-opMJLZoG.js";import{_ as Z}from"./_plugin-vue_export-helper-x3n3nnut.js";/**
 * @license
 * Copyright 2023 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */const u=Symbol("isFocusable"),x=Symbol("privateIsFocusable"),y=Symbol("externalTabIndex"),b=Symbol("isUpdatingTabIndex"),g=Symbol("updateTabIndex"),I=Symbol("hasConstructed");function G(a){var e,o,t,i;class r extends a{get[u](){return this[x]}set[u](s){this[u]!==s&&(this[x]=s,this[g]())}constructor(...s){super(...s),this[e]=!1,this[o]=null,this[t]=!1,this[i]=!1,this[u]=!0,queueMicrotask(()=>{this[I]=!0,this[g]()})}attributeChangedCallback(s,h,f){if(s!=="tabindex"){super.attributeChangedCallback(s,h,f);return}if(this.requestUpdate("tabIndex",Number(h??-1)),!this[b]){if(!this.hasAttribute("tabindex")){this[y]=null,this[g]();return}this[y]=this.tabIndex}}[(e=x,o=y,t=b,i=I,g)](){if(!this[I])return;const s=this[u]?0:-1,h=this[y]??s;this[b]=!0,this.tabIndex=h,this[b]=!1}}return d([_({noAccessor:!0})],r.prototype,"tabIndex",void 0),r}/**
 * @license
 * Copyright 2023 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */class ee extends V{computeValidity(e){this.radioElement||(this.radioElement=document.createElement("input"),this.radioElement.type="radio",this.radioElement.name="group");let o=!1,t=!1;for(const{checked:i,required:r}of e)r&&(o=!0),i&&(t=!0);return this.radioElement.checked=t,this.radioElement.required=o,{validity:{valueMissing:o&&!t},validationMessage:this.radioElement.validationMessage}}equals(e,o){if(e.length!==o.length)return!1;for(let t=0;t<e.length;t++){const i=e[t],r=o[t];if(i.checked!==r.checked||i.required!==r.required)return!1}return!0}copy(e){return e.map(({checked:o,required:t})=>({checked:o,required:t}))}}/**
 * @license
 * Copyright 2022 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */class te{get controls(){const e=this.host.getAttribute("name");return!e||!this.root||!this.host.isConnected?[this.host]:Array.from(this.root.querySelectorAll(`[name="${e}"]`))}constructor(e){this.host=e,this.focused=!1,this.root=null,this.handleFocusIn=()=>{this.focused=!0,this.updateTabIndices()},this.handleFocusOut=()=>{this.focused=!1,this.updateTabIndices()},this.handleKeyDown=o=>{const t=o.key==="ArrowDown",i=o.key==="ArrowUp",r=o.key==="ArrowLeft",l=o.key==="ArrowRight";if(!r&&!l&&!t&&!i)return;const s=this.controls;if(!s.length)return;o.preventDefault();const f=getComputedStyle(this.host).direction==="rtl"?r||t:l||t,k=s.indexOf(this.host);let c=f?k+1:k-1;for(;c!==k;){c>=s.length?c=0:c<0&&(c=s.length-1);const n=s[c];if(n.hasAttribute("disabled")){f?c++:c--;continue}for(const v of s)v!==n&&(v.checked=!1,v.tabIndex=-1,v.blur());n.checked=!0,n.tabIndex=0,n.focus(),n.dispatchEvent(new Event("change",{bubbles:!0}));break}}}hostConnected(){this.root=this.host.getRootNode(),this.host.addEventListener("keydown",this.handleKeyDown),this.host.addEventListener("focusin",this.handleFocusIn),this.host.addEventListener("focusout",this.handleFocusOut),this.host.checked&&this.uncheckSiblings(),this.updateTabIndices()}hostDisconnected(){this.host.removeEventListener("keydown",this.handleKeyDown),this.host.removeEventListener("focusin",this.handleFocusIn),this.host.removeEventListener("focusout",this.handleFocusOut),this.updateTabIndices(),this.root=null}handleCheckedChange(){this.host.checked&&(this.uncheckSiblings(),this.updateTabIndices())}uncheckSiblings(){for(const e of this.controls)e!==this.host&&(e.checked=!1)}updateTabIndices(){const e=this.controls,o=e.find(t=>t.checked);if(o||this.focused){const t=o||this.host;t.tabIndex=0;for(const i of e)i!==t&&(i.tabIndex=-1);return}for(const t of e)t.tabIndex=0}}/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */var S;const w=Symbol("checked");let oe=0;const se=K(N(Q(G(L))));let m=class extends se{get checked(){return this[w]}set checked(e){const o=this.checked;o!==e&&(this[w]=e,this.requestUpdate("checked",o),this.selectionController.handleCheckedChange())}constructor(){super(),this.maskId=`cutout${++oe}`,this[S]=!1,this.required=!1,this.value="on",this.selectionController=new te(this),this.addController(this.selectionController),this[R].role="radio",this.addEventListener("click",this.handleClick.bind(this)),this.addEventListener("keydown",this.handleKeydown.bind(this))}render(){const e={checked:this.checked};return z`
